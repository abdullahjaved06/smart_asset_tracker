...
#define PM_NUM 7
#define PM_ALL_BY_SIZE "otp nrf_modem_lib_ctrl EMPTY_0 nrf_modem_lib_rx nrf_modem_lib_tx nrf_modem_lib_sram littlefs_storage nonsecure_storage tfm tfm_sram sram_secure tfm_secure sram_primary sram_nonsecure app tfm_nonsecure"
